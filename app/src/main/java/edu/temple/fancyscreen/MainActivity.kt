...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.supervisor).setText(R.string.supervisor_value)

        with (findViewById<RecyclerView>(R.id.directReportsRecyclerView)) {
            adapter = RecyclerViewAdapter(
                arrayOf(
                    getString(R.string.staff_1),
                    getString(R.string.staff_2),
                    getString(R.string.staff_3),
                    getString(R.string.staff_4),
                    getString(R.string.staff_5),
                    getString(R.string.staff_6)
                )
            )
